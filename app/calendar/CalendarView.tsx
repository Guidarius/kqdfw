...
import { parseISODate, type LeagueDay } from "@/lib/league";
import type { Season } from "@/lib/data/league";
...
export function CalendarView({
  ...
  // One-off events + league days. Recurring weekly nights are generated
  // per-view (see expandRecurring) so they appear on every month.
  ...
  const monthEvents: CalEvent[] = [
    ...
    ...expandRecurring(recurringEvents, monthStart, monthEnd),
  ...
  const upcoming: CalEvent[] = [
    ...
    ...expandRecurring(recurringEvents, todayISO, horizonISO),
  ]
    .sort((a, b) => a.date.localeCompare(b.date))
    .slice(0, 8);
